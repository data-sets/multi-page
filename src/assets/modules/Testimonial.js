      ...
      <>
        <section className="testimonial">
          ...
          <h2>
            ...
            <blockqoute> success stories.</blockqoute>
          </h2>
          ...
          <div className="testimonial__cards">
            <div>
              ...
              <h4>Kady Baker</h4>
              <img class="testimonial__avatar" src={avatar} alt="Kady" />
            </div>
            ...
            <div>
              ...
              <h4>Aiysha Reese</h4>
              <img class="testimonial__avatar" src={avatar1} alt="Aiysha" />
            </div>
            ...
            <div>
              ...
              <h4>Arthur Clarke</h4>
              <img class="testimonial__avatar" src={avatar2} alt="Arthur" />
            </div>
          </div>
        </section>
      </>
